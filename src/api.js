...
const browserUrl = typeof window !== 'undefined' ? window.location.origin : 'http://localhost:3000';
const wsProto = typeof window !== 'undefined' && window.location.protocol === 'https:' ? 'wss:' : 'ws:';
const browserWsUrl = typeof window !== 'undefined' ? `${wsProto}//${window.location.host}/ws` : 'ws://localhost:3000/ws';

const BASE   = import.meta.env.VITE_API_URL || `${browserUrl}/api`;
const WS_URL = import.meta.env.VITE_WS_URL  || browserWsUrl;
